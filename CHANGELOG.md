...
#### Changed
- use new version of WinchModels. It supports a torque controlled winch.
- many new winch parameters in settings.yaml
- renamed `v_ro` to `set_speed` in the function step()
