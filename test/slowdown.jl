...
for i in 1:steps
    if i == 1
        global steering = [0.5,0.5,-20] # left right middle
    end
    if i == 10
...
Plots.plot(1:steps, [steering_poss, reel_out_speedss, headings], label=["Steering Pos 1" "Steering Pos 2" "Reel Out Speed 1" "Reel Out Speed 2" "Heading"])
