...
# Kite at an elevation of 60 degrees and with 45 degrees yaw, 0 roll pitch and elevation. Heading is then 250 degrees"
@testset "yaw elevation" begin
    ...
    @test isapprox(azimuth_north,   0,      atol=1e-4, rtol=1e-4)
    @test isapprox(elevation,       60,     atol=1e-4, rtol=1e-4)
    @test isapprox(heading,         127.45371955710516,    atol=1e-4, rtol=1e-4)
end
