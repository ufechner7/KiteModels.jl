...
function ControlPlots.plot(sys::PointMassSystem, reltime; kite_pos=nothing, e_z=zeros(3), zoom=false, front=false)
...
function ControlPlots.plot(s::RamAirKite, reltime; kwargs...)
