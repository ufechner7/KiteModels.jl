...
for i in 1:steps
    ...
    sys_state.var_01 =  rad2deg(trailing_edge_angle(s)[1])
    sys_state.var_02 =  rad2deg(trailing_edge_angle(s)[2])
    ...
    sys_state.var_09 =  s.integrator[s.simple_sys.turn_rate_y] / (trailing_edge_angle(s)[2] - trailing_edge_angle(s)[1])
